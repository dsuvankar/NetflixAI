...
const VideoTitle = ({ title, overview, id }) => {
  //
  return (
    <div className=" mt-[6rem] pt-[10%] sm:mt-[6rem] md:mt-[8rem] lg:mt-[10rem] xl:mt-[16rem] ml-8 sm:ml-8 lg:ml-12 p-2 w-1/2 absolute text-white z-30">
      ...
      <div className="mt-2 sm:mt-auto py-2 sm:py-4 flex justify-start">
        <button className="text-xs md:text-xs lg:text-md xl:text-lg p-2 px-5 sm:p-3 ml-0 mr-5 sm:mx-3 lg:my-4 lg:mr-4 lg:px-10 lg:py-3 bg-white text-black rounded-lg hover:bg-opacity-60 font-semibold">
          ▶&nbsp;&nbsp;&nbsp;Play
        </button>
